			...
			<div className='boxContainer'>
				<div className='boxWrapper'>
					<ul className='boxItem'>
						<Box src='images/MA.jpeg' to={{ pathname: '//github.com/MahmoudAoude' }} name='Mahmoud Aoude' label='Front-End Dev' />
						<Box src='images/Ryan.jpg' to={{ pathname: '//github.com/rd2004-boop' }} name='Ryan Denny' label='Testing & Res' />
						<Box src='images/Jishnu.jpeg' to={{ pathname: '//github.com/jishnu3000' }} name='Jishnu P. Jayaraj' label='Front-End Dev' />
						<Box src='images/MS.jpeg' to={{ pathname: '//github.com/msadiq10' }} name='Mohammed Sadiq Bagalkot ' label='Back-End Dev' />
					</ul>

					<ul className='boxItem'>
						<Box src='images/Areesha.jpeg' to={{ pathname: '//github.com/ara114' }} name='Areesha Arain' label='Testing & Res' />
